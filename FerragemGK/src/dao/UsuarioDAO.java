...
public class UsuarioDAO {
    ...
    public long cadastrar(Usuario usuario) {
        String sql = """
                     INSERT INTO usuario(nome, login, senha, nivel, ativo)
                     VALUES (?, ?, ?, ?, ?)
    ...
    public boolean loginExiste(String login, long idUsuario) {
        String sql = """
        ...
        try{
            ...
            throw new RuntimeException("Erro ao verificar login.", erro);
        }
    }
    ...
    public boolean alterar(Usuario usuario){
        ...
        if(alterarSenha){
            sql = """
                  UPDATE usuario 
                  SET nome = ?, login = ?, senha = ?, nivel = ?, ativo = ?
                  WHERE id_usuario = ?
                  """;
        } else {
            sql = """
                  UPDATE usuario
                  SET nome = ?, login = ?, nivel = ?, ativo = ?
                  WHERE id_usuario = ?
                  """;
        }
        ...
        try {
            ...
            throw new RuntimeException("Erro ao alterar usuário.", erro);
        }
    }
