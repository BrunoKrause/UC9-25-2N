...
public class ProdutoDAO {
    ...
    public long cadastrar(Produto produto){
        String sql = """
                     INSERT INTO produto (descricao, unidade, preco_custo, preco_venda, estoque, estoque_minimo, ativo)
                     VALUES (?, ?, ?, ?, ?, ?, ?)
    ...
    public boolean alterar(Produto produto){
        String sql = """
                     UPDATE produto
                     SET descricao = ?, unidade = ?, preco_custo = ?, preco_venda = ?, estoque = ?, estoque_minimo = ?, ativo = ?
                     WHERE id_produto = ?
                     """;
        ...
        try {
            ...
            throw new RuntimeException("Erro ao alterar pedido", erro);
        }
    }
    ...
    public boolean excluir(long idProduto){
        ...
        try {
            ...
            throw new RuntimeException("Não foi possível excluir o produto.", erro);
        }
    }
    
    public Produto montarProduto(ResultSet rs) throws SQLException {
    ...
    public Produto buscarPorId(long idProduto){
        ...
        try {
            ...
            throw new RuntimeException("Erro ao localizar produto.", erro);
        }
        return null;
    }
    ...
    public List<Produto> pesquisar(String filtro, String pesquisa){
        ...
        try {
            ...
            throw new RuntimeException("Erro ao pesquisar produtos.", erro);
        }
        return produtos;
    }
    ...
    public List<Produto> listarEstoqueBaixo() {
        ...
        try {
            ...
            throw new RuntimeException("Erro ao listar produtos com estoque baixo.", erro);
        }
